...
const Login = () => {
  ...
  return (
    <>
      <section className='min-h-screen relative py-20 2xl:py-40 bg-gray-900 overflow-hidden font-playfair'>
        <div className='absolute top-0 left-0 lg:bottom-0 h-full lg:h-auto w-full lg:w-4/12 bg-blue-500 lg:overflow-hidden'>
          {/* <img
