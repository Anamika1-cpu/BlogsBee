...
const UpdatePassword = () => {
  ...
  const { loading, appErr, serverErr, isPasswordUpdated, userAuth } = users;
            ...
            <div>
              ...
              {loading ? (
                <button
                  disabled
                  type='submit'
                  className='inline-flex bg-indigo-700 
                justify-center w-full px-4 py-2 border border-gray-300 
                shadow-sm text-sm font-medium rounded-md text-gray-200 '
                >
                  <span>Loading...</span>
                </button>
              ) : (
